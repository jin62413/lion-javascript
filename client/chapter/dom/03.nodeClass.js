...
// - nodeName (vs. tagName)
console.log(first.nodeName === 'SPAN'); // 태그가 아닌 것들도 나오긴 함
...
// - innerHTML
first.innerHTML = 'hellooooooo'; // 다른 사람이 내용을 변경할 수 있어서 보안에 취약
...
// - textContent
console.log(first.textCentent = 'hola!');
...
// inner css로 display : block을 넣으면 hidden이 작동하지 않음, 우선순위가 css가 높다?
