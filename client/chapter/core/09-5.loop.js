...
// iterable(반복 가능한) = String, Array, Array-like(유사배열, 배열처럼 생겼는데 배열이 아닌 것)
// 객체는 for...of를 사용하지 못함, iterable하지 못하기 때문에
...
const arrayLike = {
  ...
  2: 'div',
  length: 3,
  // [Symbol.iterator] {...} // 객체를 iterable하게 만들어주는 것
};
...
for (let value of languages) {
  ...
  // name이 'Java'라는 문자를 포함하고 있다면 break;
...
// Object.keys()
// Object.values()
// Object.entries() 객체 자체의 열거 가능한 속성을 key, value를 가진 쌍의 배열을 반환
