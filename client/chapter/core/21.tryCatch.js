...
// console.log("나중에 실행되는 코드");

// 바로 실행되는게 아닌, 사용자가 어떤 인터랙션(행동)을 했을 때 코드 로직이 실행되게
...
try {
  ...
  // console.log(user.value); // value라는 객체가 없어도 출력된다.
  ...
  // confirm('해당 데이터를 불러오는데 실패했습니다. 다시 시도할까요?'); // 예외처리
